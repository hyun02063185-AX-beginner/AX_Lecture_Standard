...
const SITE_CONFIG = {
  ...
  maxLevel: 3,                       // Level 객체 내부 계산용으로 남아있으나 Exp1에서는 UI에 노출하지 않음
  rankTitles: ["", "Wanderer", "Thinker", "Visionary"],
  skinUnlockLevel: { sayu: 1, pixel: 1, neon: 1, blueprint: 1 },
  skinGating: false,                 // Sprint 2 Exp1: Codyssey Lecture에서 이미 검증된 패턴 재사용 — 스킨 레벨 게이팅 완전 비활성화
  ...
  practiceRoom: false,                // Sprint 2 프로토타입은 practice.js를 포함하지 않음(Exp1에서 다룰 대상)
